...
class MemosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create memo" do
    assert_difference('Memo.count') do
      post memos_url, params: { memo: { id: @memo.id, text: @memo.text, user_id: @memo.user_id } }
    end
  ...
  test "should update memo" do
    patch memo_url(@memo), params: { memo: { id: @memo.id, text: @memo.text, user_id: @memo.user_id } }
